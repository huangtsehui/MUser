...
SOAP_FMAC5 int SOAP_FMAC6 ns__adduser(struct soap*, char *username, char *password, int *errcode);

SOAP_FMAC5 int SOAP_FMAC6 ns__moduser(struct soap*, char *username, char *password, int *errcode);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_ns__moduser(struct soap*);
